...
#   filename:  workdir/workdir/apis__apps__v1_openapi.json
...
class DeploymentCondition(BaseModel):
    ...
    Last time the condition transitioned from one status to another.
    """
    lastUpdateTime: Optional[v1.Time] = None
    """
...
class RollingUpdateDaemonSet(BaseModel):
    maxSurge: Optional[intstr.IntOrString] = None
    """
    ...
    """
    maxUnavailable: Optional[intstr.IntOrString] = None
    """
...
class StatefulSetStatus(BaseModel):
    availableReplicas: Optional[int] = 0
    """
...
class DaemonSetSpec(BaseModel):
    ...
    """
    template: v1_1.PodTemplateSpec
    """
    An object that describes the pod that will be created. The DaemonSet will create exactly one copy of this pod on every node that matches the template's node selector (or on every node if no node selector is specified). The only allowed template.spec.restartPolicy value is "Always". More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#pod-template
    """
    updateStrategy: Optional[DaemonSetUpdateStrategy] = {}
    """
...
class ReplicaSetSpec(BaseModel):
    ...
    """
    template: Optional[v1_1.PodTemplateSpec] = {}
    """
...
class StatefulSetSpec(BaseModel):
    ...
    """
    volumeClaimTemplates: Optional[List[v1_1.PersistentVolumeClaim]] = None
    """
...
class DaemonSet(BaseModel):
    ...
    Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    """
    spec: Optional[DaemonSetSpec] = {}
    """
    The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    status: Optional[DaemonSetStatus] = {}
    """
...
class ReplicaSet(BaseModel):
    ...
    """
    spec: Optional[ReplicaSetSpec] = {}
    """
    Spec defines the specification of the desired behavior of the ReplicaSet. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    status: Optional[ReplicaSetStatus] = {}
    """
...
class StatefulSet(BaseModel):
    ...
    Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    """
    spec: Optional[StatefulSetSpec] = {}
    """
    Spec defines the desired identities of pods in this set.
    """
    status: Optional[StatefulSetStatus] = {}
    """

...
#   filename:  workdir/workdir/apis__batch__v1_openapi.json
...
from ...apimachinery.pkg.apis.core.meta import v1 as v1_1
from ..core import v1
...
class CronJobStatus(BaseModel):
    ...
    """
    lastScheduleTime: Optional[v1_1.Time] = None
    """
    Information when was the last time the job was successfully scheduled.
    """
    lastSuccessfulTime: Optional[v1_1.Time] = None
    """
...
class JobCondition(BaseModel):
    lastProbeTime: Optional[v1_1.Time] = None
    """
    Last time the condition was checked.
    """
    lastTransitionTime: Optional[v1_1.Time] = None
    """
...
class JobStatus(BaseModel):
    ...
    """
    completionTime: Optional[v1_1.Time] = None
    """
    ...
    """
    startTime: Optional[v1_1.Time] = None
    """
...
class JobSpec(BaseModel):
    ...
    """
    selector: Optional[v1_1.LabelSelector] = None
    """
...
class CronJob(BaseModel):
    ...
    Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    """
    spec: Optional[CronJobSpec] = {}
    """
    Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    status: Optional[CronJobStatus] = {}
    """

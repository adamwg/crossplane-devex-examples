...
#   filename:  workdir/workdir/apis__policy__v1_openapi.json
...
class PodDisruptionBudgetSpec(BaseModel):
    ...
    """
    minAvailable: Optional[intstr.IntOrString] = None
    """
...
class PodDisruptionBudgetStatus(BaseModel):
    ...
    """
    disruptedPods: Optional[Dict[str, v1.Time]] = None
    """
...
class PodDisruptionBudget(BaseModel):
    ...
    """
    spec: Optional[PodDisruptionBudgetSpec] = {}
    """
    Specification of the desired behavior of the PodDisruptionBudget.
    """
    status: Optional[PodDisruptionBudgetStatus] = {}
    """

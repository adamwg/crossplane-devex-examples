...
// Defines values for APIResourceListApiVersion.
const (
	APIResourceListApiVersionV1 APIResourceListApiVersion = "v1"
)

// Valid indicates whether the value is a known member of the APIResourceListApiVersion enum.
func (e APIResourceListApiVersion) Valid() bool {
	switch e {
	case APIResourceListApiVersionV1:
		return true
	default:
		return false
	}
...
// Defines values for APIResourceListKind.
const (
	APIResourceListKindAPIResourceList APIResourceListKind = "APIResourceList"
)

// Valid indicates whether the value is a known member of the APIResourceListKind enum.
func (e APIResourceListKind) Valid() bool {
	switch e {
	case APIResourceListKindAPIResourceList:
		return true
	default:
		return false
	}
...
// Defines values for DeleteOptionsApiVersion.
const (
	DeleteOptionsApiVersionV1 DeleteOptionsApiVersion = "v1"
)

// Valid indicates whether the value is a known member of the DeleteOptionsApiVersion enum.
func (e DeleteOptionsApiVersion) Valid() bool {
	switch e {
	case DeleteOptionsApiVersionV1:
		return true
	default:
		return false
	}
...
// Defines values for DeleteOptionsKind.
const (
	DeleteOptionsKindDeleteOptions DeleteOptionsKind = "DeleteOptions"
)

// Valid indicates whether the value is a known member of the DeleteOptionsKind enum.
func (e DeleteOptionsKind) Valid() bool {
	switch e {
	case DeleteOptionsKindDeleteOptions:
		return true
	default:
		return false
	}
...
// Defines values for StatusApiVersion.
const (
	V1 StatusApiVersion = "v1"
)

// Valid indicates whether the value is a known member of the StatusApiVersion enum.
func (e StatusApiVersion) Valid() bool {
	switch e {
	case V1:
		return true
	default:
...
type IoK8SApimachineryPkgApisMetaV1APIResource = APIResource
...
type IoK8SApimachineryPkgApisMetaV1APIResourceList = APIResourceList

// APIResourceListApiVersion APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
type APIResourceListApiVersion string

// APIResourceListKind Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
type APIResourceListKind string
...
type APIResourceList struct {
	...
	APIVersion *APIResourceListApiVersion `json:"apiVersion,omitempty"`
	...
	Kind *APIResourceListKind `json:"kind,omitempty"`
...
type IoK8SApimachineryPkgApisMetaV1Condition = Condition
...
// DeleteOptionsApiVersion APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
type DeleteOptionsApiVersion string

// DeleteOptionsKind Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
type DeleteOptionsKind string

// DeleteOptions DeleteOptions may be provided when deleting an API object.
type DeleteOptions struct {
	// APIVersion APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	APIVersion *DeleteOptionsApiVersion `json:"apiVersion,omitempty"`
	...
	// Kind Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
	Kind *DeleteOptionsKind `json:"kind,omitempty"`
...
type IoK8SApimachineryPkgApisMetaV1LabelSelector = LabelSelector
...
type IoK8SApimachineryPkgApisMetaV1LabelSelectorRequirement = LabelSelectorRequirement
...
// StatusApiVersion APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
type StatusApiVersion string

// StatusKind Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
type StatusKind string

// Status Status is a return value for calls that don't return other objects.
type Status struct {
	// APIVersion APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	APIVersion *StatusApiVersion `json:"apiVersion,omitempty"`
...
type IoK8SApimachineryPkgApisMetaV1WatchEvent = WatchEvent
...
type WatchEvent struct {
	...
	Object *runtimev1.RawExtension `json:"object,omitempty"`
	Type   *string                 `json:"type,omitempty"`
}

...
#   filename:  workdir/workdir/apis__storage.k8s.io__v1_openapi.json
...
class CSIStorageCapacity(BaseModel):
    ...
    """
    nodeTopology: Optional[v1.LabelSelector] = None
    """
...
class StorageClass(BaseModel):
    ...
    """
    allowedTopologies: Optional[List[v1_1.TopologySelectorTerm]] = None
    """
...
class VolumeAttachmentSource(BaseModel):
    inlineVolumeSpec: Optional[v1_1.PersistentVolumeSpec] = None
    """
...
class VolumeAttachment(BaseModel):
    ...
    """
    status: Optional[VolumeAttachmentStatus] = {}
    """

...
#   filename:  workdir/s3_aws_upbound_io_v1beta1_object.yaml
...
class OverrideProviderItem(BaseModel):
    defaultTags: Optional[List[DefaultTag]] = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    overrideProvider: Optional[List[OverrideProviderItem]] = None
    """

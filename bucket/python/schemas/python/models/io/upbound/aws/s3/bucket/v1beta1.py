...
#   filename:  workdir/s3_aws_upbound_io_v1beta1_bucket.yaml
...
class DefaultRetentionItem(BaseModel):
    days: Optional[float] = None
    """
...
class RuleItem(BaseModel):
    defaultRetention: Optional[List[DefaultRetentionItem]] = None
    """
    Default retention period that you want to apply to new objects placed in this bucket (documented below).
    """


class ObjectLockConfigurationItem(BaseModel):
...
class ReplicationConfigurationItem(BaseModel):
...
class ServerSideEncryptionConfigurationItem(BaseModel):
    rule: Optional[List[RuleItemModel]] = None
    """
...
class AtProvider(BaseModel):
    ...
    """
    objectLockConfiguration: Optional[List[ObjectLockConfigurationItem]] = None
    """
    ...
    Region is the region you'd like your resource to be created in.
    """
    replicationConfiguration: Optional[List[ReplicationConfigurationItem]] = None
    """
    ...
    serverSideEncryptionConfiguration: Optional[
        List[ServerSideEncryptionConfigurationItem]
    ] = None
    """

...
#   filename:  workdir/s3_aws_upbound_io_v1beta1_bucketanalyticsconfiguration.yaml
...
class S3BucketDestinationItem(BaseModel):
...
class DestinationItem(BaseModel):
    s3BucketDestination: Optional[List[S3BucketDestinationItem]] = None
    """
...
class DataExportItem(BaseModel):
    ...
    """
    outputSchemaVersion: Optional[str] = None
    """
    Schema version of exported analytics data. Allowed values: V_1. Default value: V_1.
    """


class StorageClassAnalysi(BaseModel):
    dataExport: Optional[List[DataExportItem]] = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    storageClassAnalysis: Optional[List[StorageClassAnalysi]] = None
    """
...
class S3BucketDestinationItemModel(BaseModel):
    bucketAccountId: Optional[str] = None
    """
    Account ID that owns the destination bucket.
    """
...
class BucketAnalyticsConfiguration(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketAnalyticsConfiguration']] = (
...
class BucketAnalyticsConfigurationList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[BucketAnalyticsConfiguration]
    """
    List of bucketanalyticsconfigurations. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """

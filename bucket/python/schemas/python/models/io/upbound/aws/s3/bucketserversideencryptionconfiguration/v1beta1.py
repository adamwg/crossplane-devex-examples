...
#   filename:  workdir/s3_aws_upbound_io_v1beta1_bucketserversideencryptionconfiguration.yaml
...
class KmsMasterKeyIdRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class KmsMasterKeyIdSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ApplyServerSideEncryptionByDefaultItem(BaseModel):
    ...
    """
    kmsMasterKeyIdRef: Optional[KmsMasterKeyIdRef] = None
    """
    Reference to a Key in kms to populate kmsMasterKeyId.
    """
    kmsMasterKeyIdSelector: Optional[KmsMasterKeyIdSelector] = None
    """
...
class RuleItem(BaseModel):
    applyServerSideEncryptionByDefault: Optional[
        List[ApplyServerSideEncryptionByDefaultItem]
    ] = None
    """
    Single object for setting server-side encryption by default. See below.
    """
    blockedEncryptionTypes: Optional[List[str]] = None
    """
...
class ApplyServerSideEncryptionByDefaultItemModel(BaseModel):
    kmsMasterKeyId: Optional[str] = None
    """
    AWS KMS master key ID used for the SSE-KMS encryption. This can only be used when you set the value of sse_algorithm as aws:kms. The default aws/s3 AWS KMS master key is used if this element is absent while the sse_algorithm is aws:kms.
    """
...
class BucketServerSideEncryptionConfiguration(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketServerSideEncryptionConfiguration']] = (
...
class BucketServerSideEncryptionConfigurationList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[BucketServerSideEncryptionConfiguration]
    """
    List of bucketserversideencryptionconfigurations. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """

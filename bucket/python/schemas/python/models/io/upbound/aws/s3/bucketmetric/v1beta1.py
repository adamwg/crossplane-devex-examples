...
#   filename:  workdir/s3_aws_upbound_io_v1beta1_bucketmetric.yaml
...
class AccessPointRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class FilterItem(BaseModel):
    accessPoint: Optional[str] = None
    """
    S3 Access Point ARN for filtering (singular).
    """
    accessPointRef: Optional[AccessPointRef] = None
    """
    Reference to a AccessPoint in s3control to populate accessPoint.
    """
    accessPointSelector: Optional[AccessPointSelector] = None
    """
...
class AtProvider(BaseModel):
    ...
    Name of the bucket to put metric configuration.
    """
    filter: Optional[List[FilterItemModel]] = None
    """
    Object filtering that accepts a prefix, tags, or a logical AND of prefix and tags (documented below).
    """
...
class BucketMetric(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketMetric']] = 'BucketMetric'
    """
...
class BucketMetricList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[BucketMetric]
    """
    List of bucketmetrics. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """

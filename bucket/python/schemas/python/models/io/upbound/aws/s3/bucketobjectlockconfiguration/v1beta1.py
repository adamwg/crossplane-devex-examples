...
#   filename:  workdir/s3_aws_upbound_io_v1beta1_bucketobjectlockconfiguration.yaml
...
class BucketObjectLockConfiguration(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketObjectLockConfiguration']] = (
...
class BucketObjectLockConfigurationList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[BucketObjectLockConfiguration]
    """
    List of bucketobjectlockconfigurations. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """

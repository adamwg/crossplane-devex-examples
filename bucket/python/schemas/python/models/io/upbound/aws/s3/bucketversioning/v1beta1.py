...
#   filename:  workdir/s3_aws_upbound_io_v1beta1_bucketversioning.yaml
...
class VersioningConfigurationItem(BaseModel):
    mfaDelete: Optional[str] = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    versioningConfiguration: Optional[List[VersioningConfigurationItem]] = None
    """
...
class BucketVersioning(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketVersioning']] = 'BucketVersioning'
    """
...
class BucketVersioningList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[BucketVersioning]
    """
    List of bucketversionings. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """

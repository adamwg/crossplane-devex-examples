...
#   filename:  workdir/s3_aws_upbound_io_v1beta1_bucketacl.yaml
...
class AccessControlPolicyItem(BaseModel):
    grant: Optional[List[GrantItem]] = None
    """
    Set of grant configuration blocks. See below.
    """
    owner: Optional[List[OwnerItem]] = None
    """
...
class ForProvider(BaseModel):
    accessControlPolicy: Optional[List[AccessControlPolicyItem]] = None
    """
...
class BucketACL(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketACL']] = 'BucketACL'
    """
...
class BucketACLList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[BucketACL]
    """
    List of bucketacls. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """

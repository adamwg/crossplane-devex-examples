...
#   filename:  workdir/s3_aws_m_upbound_io_v1beta1_bucketwebsiteconfiguration.yaml
...
class BucketWebsiteConfiguration(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketWebsiteConfiguration']] = 'BucketWebsiteConfiguration'
    """

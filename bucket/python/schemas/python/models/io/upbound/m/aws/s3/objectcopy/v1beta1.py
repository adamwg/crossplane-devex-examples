...
#   filename:  workdir/s3_aws_m_upbound_io_v1beta1_objectcopy.yaml
...
class OverrideProvider(BaseModel):
    defaultTags: Optional[DefaultTags] = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    overrideProvider: Optional[OverrideProvider] = None
    region: str
    """
...
class ObjectCopy(BaseModel):
    ...
    """
    kind: Optional[Literal['ObjectCopy']] = 'ObjectCopy'
    """

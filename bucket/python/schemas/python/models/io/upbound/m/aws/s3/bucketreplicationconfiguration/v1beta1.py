...
#   filename:  workdir/s3_aws_m_upbound_io_v1beta1_bucketreplicationconfiguration.yaml
...
class EventThreshold(BaseModel):
...
class Metrics(BaseModel):
    eventThreshold: Optional[EventThreshold] = None
    """
...
class Filter(BaseModel):
    and_: Optional[And] = Field(None, alias='and')
    """
...
class DestinationModel(BaseModel):
    ...
    ARN of the bucket where you want Amazon S3 to store the results.
    """
    encryptionConfiguration: Optional[EncryptionConfigurationModel] = None
    """
    Configuration block that provides information about encryption. See below. If source_selection_criteria is specified, you must specify this element.
    """
    metrics: Optional[Metrics] = None
...
class BucketReplicationConfiguration(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketReplicationConfiguration']] = (

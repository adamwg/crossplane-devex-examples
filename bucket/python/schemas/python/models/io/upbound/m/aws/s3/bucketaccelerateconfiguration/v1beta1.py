...
#   filename:  workdir/s3_aws_m_upbound_io_v1beta1_bucketaccelerateconfiguration.yaml
...
class BucketAccelerateConfiguration(BaseModel):
    ...
    """
    kind: Optional[Literal['BucketAccelerateConfiguration']] = (
...
class BucketAccelerateConfigurationList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[BucketAccelerateConfiguration]
    """
    List of bucketaccelerateconfigurations. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """

...
const (
	BucketAPIVersions3AwsMUpboundIoV1Beta1 BucketAPIVersion = "s3.aws.m.upbound.io/v1beta1"
)

// Valid indicates whether the value is a known member of the BucketAPIVersion enum.
func (e BucketAPIVersion) Valid() bool {
	switch e {
	case BucketAPIVersions3AwsMUpboundIoV1Beta1:
		return true
	default:
		return false
	}
...
// IoUpboundMAwsS3V1Beta1Bucket Bucket is the Schema for the Buckets API. Provides a S3 bucket resource.
type IoUpboundMAwsS3V1Beta1Bucket = Bucket
...
// IoUpboundMAwsS3V1Beta1BucketList BucketList is a list of Bucket
type IoUpboundMAwsS3V1Beta1BucketList = BucketList
...
type BucketList struct {
	...
	Items *[]IoUpboundMAwsS3V1Beta1Bucket `json:"items,omitempty"`

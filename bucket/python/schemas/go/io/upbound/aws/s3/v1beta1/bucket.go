...
const (
	BucketAPIVersions3AwsUpboundIoV1Beta1 BucketAPIVersion = "s3.aws.upbound.io/v1beta1"
)

// Valid indicates whether the value is a known member of the BucketAPIVersion enum.
func (e BucketAPIVersion) Valid() bool {
	switch e {
	case BucketAPIVersions3AwsUpboundIoV1Beta1:
		return true
	default:
		return false
	}
...
// IoUpboundAwsS3V1Beta1Bucket Bucket is the Schema for the Buckets API. Provides a S3 bucket resource.
type IoUpboundAwsS3V1Beta1Bucket = Bucket
...
// BucketStatusAtProviderLifecycleRuleItemExpirationItem defines model for .
type BucketStatusAtProviderLifecycleRuleItemExpirationItem struct {
...
// BucketStatusAtProviderLifecycleRuleItemNoncurrentVersionExpirationItem defines model for .
type BucketStatusAtProviderLifecycleRuleItemNoncurrentVersionExpirationItem struct {
	// Days Specifies the number of days after object creation when the specific rule action takes effect.
	Days *float32 `json:"days,omitempty"`
}
...
type BucketStatusAtProviderLifecycleRuleItem struct {
	...
	Expiration *[]BucketStatusAtProviderLifecycleRuleItemExpirationItem `json:"expiration,omitempty"`
	...
	NoncurrentVersionExpiration *[]BucketStatusAtProviderLifecycleRuleItemNoncurrentVersionExpirationItem `json:"noncurrentVersionExpiration,omitempty"`
...
// BucketStatusAtProviderLoggingItem defines model for .
type BucketStatusAtProviderLoggingItem struct {
...
// BucketStatusAtProviderObjectLockConfigurationItemRuleItemDefaultRetentionItem defines model for .
type BucketStatusAtProviderObjectLockConfigurationItemRuleItemDefaultRetentionItem struct {
...
// BucketStatusAtProviderObjectLockConfigurationItemRuleItem defines model for .
type BucketStatusAtProviderObjectLockConfigurationItemRuleItem struct {
	// DefaultRetention Default retention period that you want to apply to new objects placed in this bucket (documented below).
	DefaultRetention *[]BucketStatusAtProviderObjectLockConfigurationItemRuleItemDefaultRetentionItem `json:"defaultRetention,omitempty"`
}

// BucketStatusAtProviderObjectLockConfigurationItem defines model for .
type BucketStatusAtProviderObjectLockConfigurationItem struct {
	...
	Rule *[]BucketStatusAtProviderObjectLockConfigurationItemRuleItem `json:"rule,omitempty"`
}

// BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemAccessControlTranslationItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemAccessControlTranslationItem struct {
...
// BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemMetricsItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemMetricsItem struct {
...
// BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemReplicationTimeItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemReplicationTimeItem struct {
	// Minutes Threshold within which objects are to be replicated. The only valid value is 15.
	Minutes *float32 `json:"minutes,omitempty"`
...
// BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItem struct {
	...
	AccessControlTranslation *[]BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemAccessControlTranslationItem `json:"accessControlTranslation,omitempty"`
	...
	Metrics *[]BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemMetricsItem `json:"metrics,omitempty"`
	...
	ReplicationTime *[]BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItemReplicationTimeItem `json:"replicationTime,omitempty"`

	// StorageClass Specifies the Amazon S3 storage class to which you want the object to transition.
	StorageClass *string `json:"storageClass,omitempty"`
}

// BucketStatusAtProviderReplicationConfigurationItemRulesItemFilterItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItemRulesItemFilterItem struct {
...
// BucketStatusAtProviderReplicationConfigurationItemRulesItemSourceSelectionCriteriaItemSseKmsEncryptedObjectsItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItemRulesItemSourceSelectionCriteriaItemSseKmsEncryptedObjectsItem struct {
...
// BucketStatusAtProviderReplicationConfigurationItemRulesItemSourceSelectionCriteriaItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItemRulesItemSourceSelectionCriteriaItem struct {
	// SseKmsEncryptedObjects Match SSE-KMS encrypted objects (documented below). If specified, replica_kms_key_id
	// in destination must be specified as well.
	SseKmsEncryptedObjects *[]BucketStatusAtProviderReplicationConfigurationItemRulesItemSourceSelectionCriteriaItemSseKmsEncryptedObjectsItem `json:"sseKmsEncryptedObjects,omitempty"`
}

// BucketStatusAtProviderReplicationConfigurationItemRulesItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItemRulesItem struct {
	...
	Destination *[]BucketStatusAtProviderReplicationConfigurationItemRulesItemDestinationItem `json:"destination,omitempty"`

	// Filter Filter that identifies subset of objects to which the replication rule applies (documented below).
	Filter *[]BucketStatusAtProviderReplicationConfigurationItemRulesItemFilterItem `json:"filter,omitempty"`
	...
	SourceSelectionCriteria *[]BucketStatusAtProviderReplicationConfigurationItemRulesItemSourceSelectionCriteriaItem `json:"sourceSelectionCriteria,omitempty"`

	// Status Status of the rule. Either Enabled or Disabled. The rule is ignored if status is not Enabled.
	Status *string `json:"status,omitempty"`
}

// BucketStatusAtProviderReplicationConfigurationItem defines model for .
type BucketStatusAtProviderReplicationConfigurationItem struct {
	...
	Rules *[]BucketStatusAtProviderReplicationConfigurationItemRulesItem `json:"rules,omitempty"`
}

// BucketStatusAtProviderServerSideEncryptionConfigurationItemRuleItemApplyServerSideEncryptionByDefaultItem defines model for .
type BucketStatusAtProviderServerSideEncryptionConfigurationItemRuleItemApplyServerSideEncryptionByDefaultItem struct {
...
// BucketStatusAtProviderServerSideEncryptionConfigurationItemRuleItem defines model for .
type BucketStatusAtProviderServerSideEncryptionConfigurationItemRuleItem struct {
	// ApplyServerSideEncryptionByDefault Single object for setting server-side encryption by default. (documented below)
	ApplyServerSideEncryptionByDefault *[]BucketStatusAtProviderServerSideEncryptionConfigurationItemRuleItemApplyServerSideEncryptionByDefaultItem `json:"applyServerSideEncryptionByDefault,omitempty"`
...
// BucketStatusAtProviderServerSideEncryptionConfigurationItem defines model for .
type BucketStatusAtProviderServerSideEncryptionConfigurationItem struct {
	// Rule Single object for server-side encryption by default configuration. (documented below)
	Rule *[]BucketStatusAtProviderServerSideEncryptionConfigurationItemRuleItem `json:"rule,omitempty"`
}

// BucketStatusAtProviderVersioningItem defines model for .
type BucketStatusAtProviderVersioningItem struct {
	// Enabled Enable versioning. Once you version-enable a bucket, it can never return to an unversioned state. You can, however, suspend versioning on that bucket.
	Enabled *bool `json:"enabled,omitempty"`
...
// BucketStatusAtProviderWebsiteItem defines model for .
type BucketStatusAtProviderWebsiteItem struct {
...
type BucketStatusAtProvider struct {
	...
	Logging *[]BucketStatusAtProviderLoggingItem `json:"logging,omitempty"`
	...
	ObjectLockConfiguration *[]BucketStatusAtProviderObjectLockConfigurationItem `json:"objectLockConfiguration,omitempty"`
	...
	ReplicationConfiguration *[]BucketStatusAtProviderReplicationConfigurationItem `json:"replicationConfiguration,omitempty"`
	...
	ServerSideEncryptionConfiguration *[]BucketStatusAtProviderServerSideEncryptionConfigurationItem `json:"serverSideEncryptionConfiguration,omitempty"`
	...
	Versioning *[]BucketStatusAtProviderVersioningItem `json:"versioning,omitempty"`
	...
	Website *[]BucketStatusAtProviderWebsiteItem `json:"website,omitempty"`
...
// IoUpboundAwsS3V1Beta1BucketList BucketList is a list of Bucket
type IoUpboundAwsS3V1Beta1BucketList = BucketList
...
type BucketList struct {
	...
	Items *[]IoUpboundAwsS3V1Beta1Bucket `json:"items,omitempty"`
